...
import {useGetCompaniesQuery} from "../../store/company.ts";
import {useCreateJobMutation, useDeleteJobMutation, useEditJobMutation, useGetJobsQuery} from "../../store/job.ts";
